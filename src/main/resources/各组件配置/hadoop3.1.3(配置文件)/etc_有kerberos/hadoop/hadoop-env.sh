...
export HADOOP_PID_DIR=/opt/data/tmp
...
export HDFS_NAMENODE_OPTS="-XX:+UseParallelGC -Xmx128m -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintGCDateStamps -Xloggc:${HADOOP_LOG_DIR}/gc-rm.log-$(date +'%Y%m%d%H%M')"
...
#
# This is the default:
export HDFS_SECONDARYNAMENODE_OPTS="-Dhadoop.security.logger=WARN,RFAS"
